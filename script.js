...
    { name: "대한 민국 정부 수립 때 대통령인 이승만과 같이 뽑힌 부통령의 이름은?", answer: "이시영", difficulty: "하" },
    ...
    { name: "자유당의 부정 선거 움직임에 대해 시민들이 저항할 때 수류탄을 맞고 숨진 고등학생의 이름은?", answer: "김주열", difficulty: "하"},
    ...
    { name: "전두환이 유신 헌법에 따라 제11대 대통령으로 선출 된 후 몇년 담임의 대통령을 선출하도록 헌법을 개정했나요(숫자만 입력)", answer: "7", difficulty: "중"},
    { name: "전두환 정부의 박종철 고문 치사 사건에 대한 축소 은폐 사실을 밝힌 곳은?", answer: "천주교 정의 구현 사제당", difficulty: "중"},
    ...
    { name: "1960년대 이래 급속히 진전되어 온 산업화와 도시화로 우리의 자연 환경과 생활 환경은 이제 더 이상 방치할 수 없을 정도로 악화 되었다. 지금 적절히 대처하지 아니하면 우리의 환경은 더욱 오염되어 품위 잇고 건강한 삶의 유지는 물론 지속적인 국가 발전도 어렵게 될것임이 분명하다.의 내용이 담긴 것은?", answer: "국가 환경 선언문", difficulty: "상"},
    ...
    { name: "북한이 각지의 인민 위원회를 통합하고 김일성을 위원장으로 선출한 곳의 이름은?", answer: "북조선 임시 임민 위원회", difficulty: "상"},
    ...
    { name: "천주교 신부들이 유신체제 반대 운동을 위한 조직한 곳의 이름은?", answer: "천주교 정의 구현 전국 사제당", difficulty: "상"},
